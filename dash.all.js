...
function ObjectIron(a) {
    var b;
    for (b = [], i = 0, len = a.length; len > i; i += 1) a[i].isRoot ? b.push("root") : b.push(a[i].name);
    var c = function(a, b) {
        var c;
        if (null !== a && null !== b)
...
if (function(a) {
    ...
    function c(a, b) {
        b.stack && "object" == typeof a && null !== a && a.stack && -1 === a.stack.indexOf(N) && (a.stack = d(a.stack) + "\n" + N + "\n" + d(b.stack))
    }
    ...
    function d(a) {
        for (var a = a.split("\n"), b = [], c = 0; c < a.length; ++c) {
            ...
            !d && !(-1 !== e.indexOf("(module.js:") || -1 !== e.indexOf("(node.js:")) && b.push(e)
        }
        return b.join("\n")
    }
    ...
    function f(a, b, c) {
        return function() {
            return "undefined" != typeof console && "function" == typeof console.warn && console.warn(b + " is deprecated, use " + c + " instead.", Error("").stack), a.apply(a, arguments)
        }
    }
    ...
    function m(a) {
        var a = a || Error(),
            b = h({
                when: function(b) {
                    if (b) {
                        var c = I(P, this); - 1 !== c && (Q.splice(c, 1), P.splice(c, 1))
                    }
                    return b ? b(a) : m(a)
                }
            }, function() {
        ...
        return !O && "undefined" != typeof window && !window.Touch && window.console && console.log("Should be empty:", Q), O = !0, P.push(b), Q.push(a), b
    }
    ...
    function t(a) {
        return o(a, function(a) {
            ...
            return H(a, function(d, e, f) {
                k(e) ? (a[f] = i(e), 0 === --b && c.resolve(a)) : o(e, function(d) {
    ...
    var E;
    Function.prototype.bind ? (E = Function.prototype.bind, E = E.bind(E.call)) : E = function(a) {
        return function() {
    ...
    b.nextTick = A, b.defer = g, g.prototype.makeNodeResolver = function() {
        var a = this;
        return function(b, c) {
            b ? a.reject(b) : arguments.length > 2 ? a.resolve(G(arguments, 1)) : a.resolve(c)
        }
    ...
    }, H("isResolved isFulfilled isRejected dispatch when spread get put del post send invoke keys fapply fcall fbind all allResolved timeout delay catch finally fail fin progress end done nfcall nfapply nfbind ncall napply nbind npost nsend ninvoke nend nodeify".split(" "), function(a, c) {
    ...
    }, z(h.prototype), b.nearer = i, b.isPromise = j, b.isResolved = function(a) {
        return k(a) || l(a)
        ...
        return function() {
            function b(a, b) {
                ...
                try {
                    ...
                    return "[object StopIteration]" === M(g) || g instanceof F ? g.value : m(g)
                }
                return o(f, d, e)
            }
    ...
    }, b.dispatch = q, b.dispatcher = r, b.get = r("get"), b.put = r("put"), b["delete"] = b.del = r("del");
    var R = b.post = r("post");
    b.send = function(a, b) {
        var c = G(arguments, 2);
        return R(a, b, c)
    ...
    b["try"] = s, b.fcall = s, b.fbind = function(a) {
        ...
        var c = G(c),
            d = g();
        return c.push(d.makeNodeResolver()), R(a, b, c).fail(d.reject), d.promise
    }, b.nsend = v, b.ninvoke = f(v, "ninvoke", "nsend"), b.nodeify = function(a, b) {
...
"undefined" == typeof utils.Math && (utils.Math = {}), utils.Math.to64BitNumber = function(a, b) {
    ...
    return isNaN(a) || !isFinite(a) ? goog.math.Long.ZERO : a <= -goog.math.Long.TWO_PWR_63_DBL_ ? goog.math.Long.MIN_VALUE : a + 1 >= goog.math.Long.TWO_PWR_63_DBL_ ? goog.math.Long.MAX_VALUE : 0 > a ? goog.math.Long.fromNumber(-a).negate() : new goog.math.Long(0 | a % goog.math.Long.TWO_PWR_32_DBL_, 0 | a / goog.math.Long.TWO_PWR_32_DBL_)
...
MediaPlayer = function(a) {
    ...
    var b, c, d, e, f, g = "1.0.0",
        ...
        l = function() {
            ...
            if (!this.capabilities.supportsMediaSource()) return alert("Your browser does not support the MediaSource API.  Please try another browser, such as Chrome."), void 0;
            if (!c || !d) throw "Missing view or source.";
            j = !0, this.debug.log("Playback initiated!"), f = b.getObject("streamController"), f.setVideoModel(this.videoModel), f.setAutoPlay(k), f.load(d)
        }, n = function() {
            l() && m.call(this)
        };
    return b = new dijon.System, b.mapValue("system", b), b.mapOutlet("system"), b.injectInto(h), {
        ...
        attachView: function(a) {
            if (!i) throw "MediaPlayer not initialized!";
            c = a, e = new MediaPlayer.models.VideoModel(c), this.videoModel.setElement(c), j || n.call(this)
        },
    ...
    var a = function(a, b) {
        ...
        return n
            ...
            return f.debug.log("Start searching for initialization."), g.range.start = 0, g.range.end = g.bytesToLoad, d.onloadend = function() {
                e || b.reject("Error finding initialization.")
            }, d.onload = function() {
                e = !0, g.bytesLoaded = g.range.end, c.call(f, d.response, g).then(function(a) {
                    b.resolve(a)
                })
            }, d.onerror = function() {
            ...
            if (r - 8 > d) u.debug.log("Found SIDX but we don't have all of it."), c.range.start = 0, c.range.end = c.bytesLoaded + (r - d), o.onloadend = function() {
                s || m.reject("Error loading sidx.")
            }, o.onload = function() {
                s = !0, c.bytesLoaded = c.range.end, e.call(u, o.response, c).then(function(a) {
                    m.resolve(a)
                })
            }, o.onerror = function() {
            ...
            return null === c ? (i.debug.log("No known range for SIDX request."), j.searching = !0, j.range.start = 0, j.range.end = j.bytesToLoad) : (d = c.split("-"), j.range.start = parseFloat(d[0]), j.range.end = parseFloat(d[1])), g.onloadend = function() {
                h || f.reject("Error loading sidx.")
            }, g.onload = function() {
                h = !0, j.searching ? (j.bytesLoaded = j.range.end, e.call(i, g.response, j).then(function(a) {
                    f.resolve(a)
    ...
    var a, b, c, d = -1,
        e = function(a, b) {
            var c = null;
            return b && b.Representation_asArray && b.Representation_asArray.length > 0 && (c = b.Representation_asArray[a]), c
        }, f = function(a, b) {
            var c = b.toString();
            ...
            var d = Q.defer(),
                ...
                m = null,
                n = this;
            return n.debug.log("Getting the initialization request."), f.hasOwnProperty("SegmentTemplate") ? f.SegmentTemplate.hasOwnProperty("initialization") && (k = f.SegmentTemplate.initialization, k = h(k, f.bandwidth), k = i(k, f.id)) : f.hasOwnProperty("SegmentList") && f.SegmentList.hasOwnProperty("Initialization") && f.SegmentList.Initialization.hasOwnProperty("sourceURL") ? k = f.SegmentList.Initialization.sourceURL : f.hasOwnProperty("SegmentBase") && f.SegmentBase.hasOwnProperty("Initialization") && f.SegmentBase.Initialization.hasOwnProperty("range") ? (k = f.BaseURL, m = f.SegmentBase.Initialization.range) : f.hasOwnProperty("mimeType") && n.manifestExt.getIsTextTrack(f.mimeType) ? (k = f.BaseURL, m = 0) : (l = f.BaseURL, n.baseURLExt.loadInitialization(l).then(function(a) {
                n.debug.log("Got an initialization."), g = new MediaPlayer.vo.SegmentRequest, g.streamType = c, g.type = "Initialization Segment", g.url = j(l, f.BaseURL), g.range = a, d.resolve(g)
            }, function() {
                n.errHandler.downloadError("Error loading initialization.")
            })), k && k.length > 0 && (n.debug.log("Got an initialization."), g = new MediaPlayer.vo.SegmentRequest, g.streamType = c, g.type = "Initialization Segment", g.url = j(k, f.BaseURL), g.range = m, d.resolve(g)), d.promise
        }, l = function(c) {
            var e, f, g, h, i, j, k = !1;
            return this.debug.log("Checking for stream end..."), a ? (this.debug.log("Live never ends! (TODO)"), k = !1) : c.hasOwnProperty("segments") && null !== c.segments ? (this.debug.log("Segments: " + d + " / " + c.segments.length), k = d >= c.segments.length) : c.hasOwnProperty("SegmentTemplate") && !c.SegmentTemplate.hasOwnProperty("SegmentTimeline") && (f = 1, i = 1, h = Math.floor(b), c.SegmentTemplate.hasOwnProperty("duration") && (e = c.SegmentTemplate.duration, c.SegmentTemplate.hasOwnProperty("timescale") && (f = c.SegmentTemplate.timescale), c.SegmentTemplate.hasOwnProperty("startNumber") && (i = c.SegmentTemplate.startNumber), g = e / f, j = d - i, this.debug.log("SegmentTemplate: " + g + " * " + j + " = " + g * j + " / " + h), k = g * j >= h)), Q.when(k)
        }, m = function(a, b) {
            var c, d, e, h, i, j, k, l, m = [],
                n = 0,
                o = 1,
                p = 1;
            for (a.hasOwnProperty("startNumber") && (o = a.startNumber), a.hasOwnProperty("timescale") && (p = a.timescale), c = b.S_asArray, e = 0, h = c.length; h > e; e += 1)
                for (d = c[e], j = 0, d.hasOwnProperty("r") && (j = d.r), i = 0; j >= i; i += 1) k = new Dash.vo.Segment, k.timescale = p, d.hasOwnProperty("t") ? (k.startTime = d.t, n = d.t) : k.startTime = n, k.duration = d.d, l = a.media, l = f(l, o), l = g(l, k.startTime), k.media = l, m.push(k), n += k.duration, o += 1;
            return Q.when(m)
        }, n = function(a) {
            var b, c, d, e, f, g = [],
                h = 1;
            for (a.hasOwnProperty("startNumber") && (h = Math.max(a.startNumber, 1)), f = (h - 1) * a.duration, b = 0, c = a.SegmentURL_asArray.length; c > b; b += 1) e = a.SegmentURL_asArray[b], d = new Dash.vo.Segment, d.media = e.media, d.mediaRange = e.mediaRange, d.index = e.index, d.indexRange = e.indexRange, d.timescale = a.timescale, d.duration = a.duration, d.startTime = f + b * a.duration, g.push(d);
            return Q.when(g)
        }, o = function(a) {
            var b = a.BaseURL,
                c = null;
            return a.hasOwnProperty("SegmentBase") && a.SegmentBase.hasOwnProperty("indexRange") && (c = a.SegmentBase.indexRange), this.baseURLExt.loadSegments(b, c)
        }, p = function(a) {
            var b;
            ...
            if (b && b.length > 0)
                for (f = b.length - 1; f >= 0; f--)
                    if (c = b[f], d = c.startTime / c.timescale, e = c.duration / c.timescale, a >= d && d + e >= a) {
                        g = f;
                        break
                    }
            return -1 === g && (console.log("Couldn't figure out a time!"), console.log("Time: " + a), console.log(b)), Q.when(g)
        }, r = function(a, b) {
            var c, d, e = -1,
                f = 1,
                g = 1;
            if (!b.hasOwnProperty("duration")) throw "Expected 'duration' attribute on SegmentTemplate!";
            return c = b.duration, b.hasOwnProperty("timescale") && (f = b.timescale), b.hasOwnProperty("startNumber") && (g = b.startNumber), d = c / f, e = Math.floor(a / d), e += g, Q.when(e)
        }, s = function(a, b, d) {
            var e, k, l = new MediaPlayer.vo.SegmentRequest,
                m = 1;
            return b.hasOwnProperty("timescale") && (m = b.timescale), k = b.duration * a / m, k = Math.floor(k), e = b.media, e = f(e, a), e = g(e, k), e = h(e, d.bandwidth), e = i(e, d.id), l.streamType = c, l.type = "Media Segment", l.url = j(e, d.BaseURL), l.duration = b.duration / m, l.timescale = m, l.startTime = a * b.duration / m, Q.when(l)
        }, t = function(a, b, d) {
            if (null === b || void 0 === b) return Q.when(null);
            var e, k = new MediaPlayer.vo.SegmentRequest;
            return e = j(b.media, d.BaseURL), e = f(e, a), e = g(e, b.startTime), e = h(e, d.bandwidth), e = i(e, d.id), k.streamType = c, k.type = "Media Segment", k.url = e, k.range = b.mediaRange, k.startTime = b.startTime / b.timescale, k.duration = b.duration / b.timescale, k.timescale = b.timescale, Q.when(k)
        }, u = function(a, b, c) {
            var f, g, h, i = e(b, c),
                j = !1,
                k = this;
            return k.debug.log("Getting the request for time: " + a), f = Q.defer(), p.call(k, i).then(function(b) {
                var c;
                if (k.debug.log("Got segments."), k.debug.log(b), null === b) {
                    if (!i.hasOwnProperty("SegmentTemplate")) throw "Expected SegmentTemplate!";
                    j = !0, k.debug.log("No segments found, so we must be using a SegmentTemplate."), c = r.call(k, a, i.SegmentTemplate)
                } else k.debug.log("Got a list of segments, so dig deeper."), i.segments = b, j = !1, c = q.call(k, a, b);
                return c
            }).then(function(b) {
                return k.debug.log("Index for time " + a + " is " + b), d = b, l.call(k, i)
            }).then(function(a) {
                var b = null;
                return k.debug.log("Stream finished? " + a), a ? (g = new MediaPlayer.vo.SegmentRequest, g.action = g.ACTION_COMPLETE, k.debug.log("Signal complete."), k.debug.log(g), f.resolve(g)) : j ? b = s.call(k, d, i.SegmentTemplate, i) : (h = i.segments[d], b = t.call(k, d, h, i)), b
            }).then(function(a) {
            ...
            return d += 1, i.debug.log("New index: " + d), c = Q.defer(), l.call(i, h).then(function(a) {
                i.debug.log("Stream finished? " + a), a ? (f = new MediaPlayer.vo.SegmentRequest, f.action = f.ACTION_COMPLETE, i.debug.log("Signal complete."), i.debug.log(f), c.resolve(f)) : p.call(i, h).then(function(a) {
                    var b;
                    if (i.debug.log("Got segments."), i.debug.log(a), null === a) {
                        if (!h.hasOwnProperty("SegmentTemplate")) throw "Expected SegmentTemplate!";
                        i.debug.log("No segments found, so we must be using a SegmentTemplate."), b = s.call(i, d, h.SegmentTemplate, h)
                    } else h.segments = a, g = h.segments[d], b = t.call(i, d, g, h);
                    return b
                }).then(function(a) {
                    i.debug.log("Got a request."), i.debug.log(a), c.resolve(a)
                })
            }), c.promise
        }, w = function(a, b) {
            ...
            return g = d, 0 > g && (g = 0), p.call(c, j).then(function(a) {
                if (null === a || void 0 === a) {
                    ...
                    i = j.SegmentTemplate.duration, j.SegmentTemplate.hasOwnProperty("timescale") && (k = j.SegmentTemplate.timescale), f = i / k * g
    ...
    getSegmentInfoFor: function(a) {
        return a.hasOwnProperty("SegmentBase") ? a.SegmentBase : a.hasOwnProperty("SegmentList") ? a.SegmentList : a.hasOwnProperty("SegmentTemplate") ? a.SegmentTemplate : null
    },
    getLiveOffset: function(a) {
        "use strict";
        var b = 15;
        return a.hasOwnProperty("suggestedPresentationDelay") && (b = a.suggestedPresentationDelay), Q.when(b)
    },
    ...
    getLiveEdge: function(a, b) {
        ...
        return d.getLiveOffset(a).then(function(i) {
            a.hasOwnProperty("availabilityEndTime") ? (c = a.availabilityEndTime, f = (c.getTime() - h.getTime()) / 1e3) : f = (g.getTime() - h.getTime()) / 1e3, d.getLiveStart(a, b).then(function(a) {
                f += a, f -= i, e.resolve(f)
            })
        }), e.promise
    },
    getPresentationOffset: function(a, b) {
        var c, d, e, f = 0,
            g = 1;
        return d = a.Period_asArray[b].AdaptationSet_asArray[0].Representation_asArray[0], e = this.getSegmentInfoFor(d), null !== e && void 0 !== e && e.hasOwnProperty("presentationTimeOffset") && (c = e.presentationTimeOffset, e.hasOwnProperty("timescale") && (g = e.timescale), f = c / g), Q.when(f)
    },
    ...
    getDuration: function(a, b) {
        "use strict";
        var c = 0 / 0;
        return b ? c = Number.POSITIVE_INFINITY : a.mediaPresentationDuration ? c = a.mediaPresentationDuration : a.availabilityEndTime && a.availabilityStartTime && (c = a.availabilityEndTime.getTime() - a.availabilityStartTime.getTime()), Q.when(c)
    },
    ...
    getTimestampOffsetForPeriod: function(a, b, c) {
        ...
        return d.getStartOffsetForPeriod(b, a).then(function(e) {
            ...
            if ("undefined" != typeof f) return Q.when(b.Period_asArray[a].start - e);
            for (var g = [], h = Q.defer(), i = 0; a > i; i++) g.push(d.getDurationForPeriod(i, b, c));
    ...
    getStartOffsetForPeriod: function(a, b) {
        ...
        for (d = 0; b > d; d++)
            if (g.hasOwnProperty("BaseURL") && f[d].BaseURL == g.BaseURL) {
                c = Q.defer(), Q.all([e.getLiveStart(a, d), e.getLiveStart(a, b)]).then(function(a) {
                    "undefined" == typeof a || isNaN(a[0] && !isNaN(a[0])) || (h = Math.abs(a[0] - a[1])), c.resolve(h)
                });
                break
            }
    ...
    var a = 31536e3,
        ...
        i = [{
            ...
            converter: function(g) {
                var h = f.exec(g);
                return parseFloat(h[2] || 0) * a + parseFloat(h[4] || 0) * b + parseFloat(h[6] || 0) * c + parseFloat(h[8] || 0) * d + parseFloat(h[10] || 0) * e + parseFloat(h[12] || 0)
            }
        }, {
            type: "datetime",
            test: function(a) {
        ...
        j = function() {
            ...
            var c, d = new X2JS(i, "", !0),
                e = new ObjectIron(m());
            return this.debug.log("Converting from XML."), c = d.xml_str2json(a), c.hasOwnProperty("BaseURL") ? c.BaseURL = c.BaseURL_asArray[0] : (this.debug.log("Setting baseURL: " + b), c.BaseURL = b), 0 !== c.BaseURL.indexOf("http") && (c.BaseURL = b + c.BaseURL), this.debug.log("Flatten manifest properties."), e.run(c), this.debug.log("Parsing complete."), Q.when(c)
        };
    return {
        debug: void 0,
        parse: n
    ...
    "use strict";
    this.indexRange = null, this.index = null, this.mediaRange = null, this.media = null, this.duration = 0 / 0, this.startTime = 0 / 0, this.timescale = 0 / 0
    ...
    return {
        ...
        getPlaybackQuality: function(b, e) {
            var f, g, h, i, j, k = this,
                ...
                m = 999,
                n = [];
            return j = c(b), k.debug.log("ABR enabled? (" + a + ")"), a ? (k.debug.log("Check ABR rules."), k.getMetricsFor(e).then(function(a) {
                k.abrRulesCollection.getRules().then(function(c) {
                    for (f = 0, g = c.length; g > f; f += 1) n.push(c[f].checkIndex(j, a, e));
                    Q.all(n).then(function(a) {
                        for (k.debug.log(a), i = {}, i[MediaPlayer.rules.SwitchRequest.prototype.STRONG] = 999, i[MediaPlayer.rules.SwitchRequest.prototype.WEAK] = 999, i[MediaPlayer.rules.SwitchRequest.prototype.DEFAULT] = 999, f = 0, g = a.length; g > f; f += 1) h = a[f], h.quality !== MediaPlayer.rules.SwitchRequest.prototype.NO_CHANGE && (i[h.priority] = Math.min(i[h.priority], h.quality));
                        999 !== i[MediaPlayer.rules.SwitchRequest.prototype.WEAK] && (m = i[MediaPlayer.rules.SwitchRequest.prototype.WEAK]), 999 !== i[MediaPlayer.rules.SwitchRequest.prototype.DEFAULT] && (m = i[MediaPlayer.rules.SwitchRequest.prototype.DEFAULT]), 999 !== i[MediaPlayer.rules.SwitchRequest.prototype.STRONG] && (m = i[MediaPlayer.rules.SwitchRequest.prototype.STRONG]), 999 !== m && void 0 !== m && (j = m), k.manifestExt.getRepresentationCount(e).then(function(a) {
                            0 > j && (j = 0), j >= a && (j = a - 1), d(b, j), k.debug.log("New quality of " + j), l.resolve(j)
                        })
                    })
                })
            })) : (k.debug.log("Unchanged quality of " + j), l.resolve(j)), l.promise
        },
    ...
    var a, b, c, d, e, f = 1e3,
        ...
        I = function(a) {
            ...
            var c = 0,
                d = null;
            H === !1 && (d = G.start, c = a.getTime() - d.getTime(), G.duration = c, G.stopreason = b, H = !0)
        }, K = function() {
            ...
            if (m && n) {
                ...
                K.call(this).then(function(c) {
                    z = c, a.debug.log("BufferController begin " + b + " validation with interval: " + f), I.call(a, i), clearInterval(v), v = setInterval(w.bind(a), f, a)
                })
            }
        }, M = function() {
            var a;
            null === v && (q === !1 && (a = new Date, J(a, MediaPlayer.vo.metrics.PlayList.Trace.USER_REQUEST_STOP_REASON), F = this.metricsModel.addPlayList(b, a, 0, MediaPlayer.vo.metrics.PlayList.INITIAL_PLAY_START_REASON)), this.debug.log("BufferController " + b + " start."), n = !0, o = !0, L.call(this))
        }, N = function(a) {
            var c;
            this.debug.log("BufferController " + b + " seek: " + a), q = !0, r = a - y - E, c = new Date, J(c, MediaPlayer.vo.metrics.PlayList.Trace.USER_REQUEST_STOP_REASON), F = this.metricsModel.addPlayList(b, c, r, MediaPlayer.vo.metrics.PlayList.SEEK_START_REASON), M.call(this)
        }, O = function() {
            this.debug.log("BufferController " + b + " stop."), I.call(this, h), clearInterval(v), v = null, n = !1, o = !1, J(new Date, MediaPlayer.vo.metrics.PlayList.Trace.USER_REQUEST_STOP_REASON)
        }, P = function(a, b) {
            var c = null;
            return b && b.Representation_asArray && b.Representation_asArray.length > 0 && (c = b.Representation_asArray[a]), c
        }, R = function() {
            var a = this;
            l === k && (x && !o && (x = !1, this.videoModel.stallStream(b, x)), I.call(a, i))
        }, S = function(a, c) {
            var e = this;
            e.debug.log(b + " Bytes finished loading: " + a.url), e.fragmentController.process(c.data).then(function(a) {
                if (null !== a) {
                    var c = P(u, e.getData()),
                        f = e.videoModel.getCurrentTime(),
                        g = new Date;
                    e.debug.log("Push (" + b + ") bytes: " + a.byteLength), H === !0 && l !== h && -1 !== u && (H = !1, G = e.metricsModel.appendPlayListTrace(F, c.id, null, g, f, null, 1, null)), Q.when(B || !0).then(function() {
                        B = e.sourceBufferExt.append(d, a, e.videoModel), B.then(function() {
                            if (e.debug.log("Append " + b + " complete: " + d.buffered.length), d.buffered.length > 0) {
                                var a, c, f = d.buffered;
                                for (e.debug.log("Number of buffered " + b + " ranges: " + f.length), a = 0, c = f.length; c > a; a += 1) e.debug.log("Buffered " + b + " Range: " + f.start(a) + " - " + f.end(a))
                            }
                            R.call(e)
                        })
                    })
            ...
            var c = this;
            l === k && I.call(c, i), this.errHandler.downloadError("Error loading " + b + " fragment: " + a.url)
        }, U = function() {
            O.call(this)
        }, V = function(a, d) {
            var e = null;
            return p && (this.debug.log("Marking a special seek for initial " + b + " playback."), q || (q = !0, r = 0), p = !1), e = a ? this.indexHandler.getInitRequest(d, c) : Q.when(null)
        }, W = function(e) {
            var f, g = this;
            if (t && !q) g.debug.log("Data changed - loading the " + b + " fragment for time: " + a), f = g.indexHandler.getSegmentRequestForTime(a - E - y, e, c);
            else {
                var h = Q.defer(),
                    i = g.videoModel.getCurrentTime();
                f = h.promise, q = !1, g.sourceBufferExt.getBufferRange(d, i).then(function(a) {
                    null !== a && (i = a.end), g.debug.log("Loading the " + b + " fragment for time: " + i), g.indexHandler.getSegmentRequestForTime(i - E - y, e, c).then(function(a) {
                        h.resolve(a)
                    })
                })
            }
            ...
            if (null !== a) {
                switch (a.action) {
                    case "complete":
                        d.debug.log(b + " Stream is complete."), J(new Date, MediaPlayer.vo.metrics.PlayList.Trace.END_OF_CONTENT_STOP_REASON), U.call(d);
                        break;
                    case "download":
                        for (var e = C.length - 1; e >= 0; --e)
                            if (C[e].startTime === a.startTime) {
                                if (d.debug.log(b + " Fragment already loaded for time: " + a.startTime), C[e].url === a.url) return d.debug.log(b + " Fragment url already loaded: " + a.url), d.indexHandler.getNextSegmentRequest(u, c).then(X.bind(d)), void 0;
                                C.splice(e, 1);
                                break
                            }
                        C.push(a), d.debug.log("Loading an " + b + " fragment: " + a.url), I.call(d, k), d.fragmentLoader.load(a).then(S.bind(d, a), T.bind(d, a));
                        break;
                    default:
            ...
            o && (e > a ? x || (this.debug.log("Waiting for more " + b + " buffer before starting playback."), x = !0, this.videoModel.stallStream(b, x)) : (this.debug.log("Got enough " + b + " buffer to start."), o = !1, x = !1, this.videoModel.stallStream(b, x)))
        }, Z = function() {
            var a = -1;
            return a = this.videoModel.getCurrentTime(), this.debug.log("Working time is video time: " + a), a
        }, $ = function() {
            var a, e = this,
                h = null,
                m = new Date,
                ...
                p = Z.call(e);
            e.debug.log("BufferController.validate() " + b + " | state: " + l), e.debug.log(b + " Playback rate: " + e.videoModel.getElement().playbackRate), e.debug.log(b + " Working time: " + p), e.debug.log(b + " Video time: " + n), e.sourceBufferExt.getBufferLength(d, p).then(function(d) {
                e.debug.log("Current " + b + " buffer length: " + d), e.metricsModel.addBufferLevel(b, new Date, d), Y.call(e, d), l === k && g > d ? x || (e.debug.log("Stalling " + b + " Buffer: " + b), J(new Date, MediaPlayer.vo.metrics.PlayList.Trace.REBUFFERING_REASON), x = !0, o = !0, e.videoModel.stallStream(b, x)) : l === i && (I.call(e, j), e.bufferExt.shouldBufferMore(d, f / 1e3).then(function(d) {
                    d ? e.abrController.getPlaybackQuality(b, c).then(function(c) {
                        if (e.debug.log(b + " Playback quality: " + c), e.debug.log("Populate " + b + " buffers."), void 0 !== c && (a = c), s = c !== u, s === !0) {
                            if (h = P(a, e.getData()), null === h || void 0 === h) throw "Unexpected error!";
                            J(new Date, MediaPlayer.vo.metrics.PlayList.Trace.REPRESENTATION_SWITCH_STOP_REASON), e.metricsModel.addRepresentationSwitch(b, m, n, h.id)
                        }
                        return e.debug.log(s ? b + " Quality changed to: " + c : "Quality didn't change."), V.call(e, s, c)
                    }).then(function(c) {
                        null !== c ? (e.debug.log("Loading " + b + " initialization: " + c.url), e.debug.log(c), I.call(e, k), e.fragmentLoader.load(c).then(S.bind(e, c), T.bind(e, c)), u = a) : W.call(e, a).then(X.bind(e))
                    }) : (q = !1, l === j && I.call(e, i))
                }))
            })
        };
    return w = function() {
        ...
        initialize: function(a, b, c, d, e, f) {
            ...
            g.setVideoModel(f), g.setType(a), g.setPeriodIndex(b), g.setData(c), g.setBuffer(d), g.setMinBufferTime(e), g.indexHandler.setIsLive(i), g.manifestExt.getTimestampOffsetForPeriod(b, g.manifestModel.getValue(), i).then(function(a) {
                g.getBuffer().timestampOffset = a, E = a
            }), g.manifestExt.getStartOffsetForPeriod(g.manifestModel.getValue(), b).then(function(a) {
                y = a, g.manifestExt.getDurationForPeriod(b, g.manifestModel.getValue(), i).then(function(a) {
        ...
        setData: function(d) {
            var e = this;
            null !== c && void 0 !== c ? e.abrController.getPlaybackQuality(b, c).then(function(b) {
        ...
        setMinBufferTime: function(a) {
            var c = this;
            e = a, f = 1e3 * e / 4, f = Math.max(f, 1e3), null !== v && (c.debug.log("Changing " + b + " validate interval: " + f), clearInterval(v), v = setInterval(w.bind(this), f, this))
        },
        clearMetrics: function() {
            var a = this;
            null !== b && "" !== b && a.metricsModel.clearCurrentMetricsForType(b)
        },
        start: M,
        seek: N,
        stop: O
    ...
    var a = [],
        ...
        d = function() {
            var e = new XMLHttpRequest,
                ...
                h = !1,
                i = this;
            a.length > 0 ? (b = a.shift(), b.requestStartDate = new Date, b.firstByteDate = b.requestStartDate, c = !0, e.open("GET", b.url, !0), e.responseType = "arraybuffer", b.range && e.setRequestHeader("Range", "bytes=" + b.range), e.onprogress = function(a) {
                g && (g = !1, (!a.lengthComputable || a.lengthComputable && a.total != a.loaded) && (b.firstByteDate = new Date))
            }, e.onload = function() {
                if (!(e.status < 200 || e.status > 299)) {
                    ...
                    i.debug.log("segment loaded: (" + e.status + ", " + g + "ms, " + j + "ms, " + k + "ms) " + b.url), f = i.metricsModel.addHttpRequest(b.streamType, null, b.type, b.url, null, b.range, b.requestStartDate, b.firstByteDate, b.requestEndDate, e.status, null, b.duration), i.metricsModel.appendHttpTrace(f, a, (new Date).getTime() - a.getTime(), [c.byteLength]), b.deferred.resolve({
                        data: c,
                        request: b
                ...
                if (!h) {
                    ...
                    var a = b.firstByteDate.getTime() - b.requestStartDate.getTime(),
                        ...
                        g = b.requestEndDate.getTime() - b.requestStartDate.getTime();
                    i.debug.log("segment loaded: (" + e.status + ", " + a + "ms, " + c + "ms, " + g + "ms) " + b.url), f = i.metricsModel.addHttpRequest(b.streamType, null, b.type, b.url, null, b.range, b.requestStartDate, b.firstByteDate, b.requestEndDate, e.status, null, b.duration), b.deferred.reject("Error loading fragment."), d.call(i)
                }
            }, e.send()) : c = !1
        }, e = function(b) {
            var e = Q.defer();
    ...
    var a = function(a) {
        ...
        return -1 !== a.indexOf("/") && (b = a.substring(0, a.lastIndexOf("/") + 1)), b
            ...
            var c = a(b),
                ...
                g = !1,
                h = this;
            return this.debug.log("Start loading manifest: " + b), e.open("GET", b, !0), e.onloadend = function() {
                g || d.reject("Error loading manifest.")
            }, e.onload = function() {
                g = !0, h.metricsModel.addHttpRequest("stream", null, "MPD", b, null, null, f, new Date, e.status, null, null), h.parser.parse(e.responseText, c).then(function(a) {
                    a.mpdUrl = b, d.resolve(a)
                })
            }, e.onerror = function() {
                h.metricsModel.addHttpRequest("stream", null, "MPD", b, null, null, f, new Date, e.status, null, null), d.reject("Error loading manifest.")
            }, e.send(), d.promise
        };
    return {
        debug: void 0,
    ...
    var a = 0 / 0,
        ...
        d = function() {
            ...
            d.call(this), isNaN(a) || (this.debug.log("Refresh manifest in " + a + " seconds."), b = setInterval(c.bind(this), 1e3 * a, this))
        }, f = function() {
            var b = this,
                c = b.manifestModel.getValue();
            void 0 !== c && null !== c && b.manifestExt.getRefreshDelay(c).then(function(c) {
                a = c, e.call(b)
            })
        };
    return c = function() {
        ...
        b.hasOwnProperty("Location") && (c = b.Location), a.debug.log("Refresh manifest @ " + c), a.manifestLoader.load(c).then(function(b) {
            a.manifestModel.setValue(b), a.debug.log("Manifest has been refreshed."), a.debug.log(b), f.call(a), a.system.notify("manifestUpdated")
        })
    }, {
        debug: void 0,
        system: void 0,
    ...
    return {
        ...
        addTcpConnection: function(a, b, c, d, e, f) {
            ...
            return g.tcpid = b, g.dest = c, g.topen = d, g.tclose = e, g.tconnect = f, this.getMetricsFor(a).TcpList.push(g), g
        },
        addHttpRequest: function(a, b, c, d, e, f, g, h, i, j, k, l) {
            var m = new MediaPlayer.vo.metrics.HTTPRequest;
            return m.tcpid = b, m.type = c, m.url = d, m.actualurl = e, m.range = f, m.trequest = g, m.tresponse = h, m.tfinish = i, m.responsecode = j, m.interval = k, m.mediaduration = l, this.getMetricsFor(a).HttpList.push(m), m
        },
        ...
        addRepresentationSwitch: function(a, b, c, d, e) {
            ...
            return f.t = b, f.mt = c, f.to = d, f.lto = e, this.getMetricsFor(a).RepSwitchList.push(f), f
        },
        addBufferLevel: function(a, b, c) {
            var d = new MediaPlayer.vo.metrics.BufferLevel;
            return d.t = b, d.level = c, this.getMetricsFor(a).BufferLevel.push(d), d
        },
        addPlayList: function(a, b, c, d) {
            var e = new MediaPlayer.vo.metrics.PlayList;
            return e.start = b, e.mstart = c, e.starttype = d, this.getMetricsFor(a).PlayList.push(e), e
        },
        appendPlayListTrace: function(a, b, c, d, e, f, g, h) {
            var i = new MediaPlayer.vo.metrics.PlayList.Trace;
            return i.representationid = b, i.subreplevel = c, i.start = d, i.mstart = e, i.duration = f, i.playbackspeed = g, i.stopreason = h, a.trace.push(i), i
        }
    }
    ...
    setMediaKey: function(a, b) {
        var c = "WebKitSetMediaKeys" in a,
            ...
            e = "SetMediaKeys" in a;
        return e ? a.SetMediaKeys(b) : c ? a.WebKitSetMediaKeys(b) : d ? a.msSetMediaKeys(b) : (this.debug.log("no setmediakeys function in element"), void 0)
    },
    ...
    var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p = null,
        ...
        D = -1,
        E = function() {
            this.debug.log("Attempting play..."), z && (this.debug.log("Do play."), this.videoModel.play())
        }, F = function() {
            this.debug.log("Do pause."), this.videoModel.pause()
        }, G = function(a) {
            this.debug.log("Attempting seek..."), z && (this.debug.log("Do seek: " + a), this.system.notify("setCurrentTime"), this.videoModel.setCurrentTime(a), s && s.seek(a), u && u.seek(a))
        }, H = function(a) {
            var b, c = this;
            if (b = "msneedkey" !== a.type ? a.type : p, C.push({
                type: b,
                initData: a.initData
            }), this.debug.log("DRM: Key required for - " + b), r && p && !B) try {
                B = c.protectionController.selectKeySystem(p, r)
            } catch (d) {
                F.call(c), c.debug.log(d), c.errHandler.mediaKeySystemSelectionError(d)
            }
            ...
            var b = this,
                ...
                e = null,
                f = null;
            this.debug.log("DRM: Got a key message..."), c = a.target, d = new Uint16Array(a.message.buffer), e = String.fromCharCode.apply(null, d), f = a.destinationURL, b.protectionController.updateFromMessage(B, c, e, f).fail(function(a) {
            ...
            var a = Q.defer(),
                ...
                d = function(a) {
                    ...
                    c.debug.log("MediaSource is open!"), c.debug.log(d), b.removeEventListener("sourceopen", e), b.removeEventListener("webkitsourceopen", e), a.resolve(b)
                };
            return c.debug.log("MediaSource should be closed. (" + b.readyState + ")"), b.addEventListener("sourceclose", d, !1), b.addEventListener("webkitsourceclose", d, !1), b.addEventListener("sourceopen", e, !1), b.addEventListener("webkitsourceopen", e, !1), c.mediaSourceExt.attachMediaSource(b, c.videoModel), c.debug.log("MediaSource attached to video.  Waiting on open..."), a.promise
        }, M = function() {
            s && s.clearMetrics(), u && u.clearMetrics()
        }, N = function() {
            var a, c, d, e = this;
            s && s.stop(), u && u.stop(), M.call(this), A || (s && (a = s.getBuffer(), e.sourceBufferExt.abort(a), e.sourceBufferExt.removeSourceBuffer(b, a)), u && (c = u.getBuffer(), e.sourceBufferExt.abort(c), e.sourceBufferExt.removeSourceBuffer(b, c)), w && (d = w.getBuffer(), e.sourceBufferExt.abort(d), e.sourceBufferExt.removeSourceBuffer(b, d))), s = null, u = null, w = null, p = null, q = null, e.protectionController.teardownKeySystem(B), B = null, C = [], r = null, e.videoModel.setSource(null)
        }, O = function(a, b, c, d) {
            if (a && b && c)
            ...
            var a, c = Q.defer(),
                ...
                h = g.manifestModel.getValue(),
                i = g.manifestExt.getIsLive(h);
            return g.debug.log("Gathering information for buffers. (1)"), g.manifestExt.getDuration(h, i).then(function() {
                g.debug.log("Gathering information for buffers. (2)"), g.bufferExt.decideBufferLength(h.minBufferTime).then(function(b) {
                    return g.debug.log("Gathering information for buffers. (3)"), g.debug.log("Buffer time: " + b), a = b, g.manifestExt.getVideoData(h, D)
                }).then(function(i) {
                    return null !== i ? (g.debug.log("Create video buffer."), g.manifestExt.getDataIndex(i, h, D).then(function(a) {
                        t = a, g.debug.log("Save video track: " + t)
                    }), g.manifestExt.getCodec(i).then(function(a) {
                        return g.debug.log("Video codec: " + a), p = a, g.manifestExt.getContentProtectionData(i).then(function(c) {
                            var d = Q.defer();
                            return g.debug.log("Video contentProtection"), r = c, g.capabilities.supportsCodec(g.videoModel.getElement(), a) ? d = g.sourceBufferExt.createSourceBuffer(b, a) : (g.debug.log("Codec (" + a + ") is not supported."), alert("Codec (" + a + ") is not supported."), d = Q.when(null)), d
                        })
                    }).then(function(b) {
                        null === b ? g.debug.log("No buffer was created, skipping video stream.") : (s = g.system.getObject("bufferController"), s.initialize("video", D, i, b, a, g.videoModel), g.debug.log("Video is ready!")), d = !0, O.call(g, d, e, f, c)
                    }, function() {
                        alert("Error creating source buffer."), d = !0, O.call(g, d, e, f, c)
                    })) : (g.debug.log("No video data."), d = !0, O.call(g, d, e, f, c)), g.manifestExt.getAudioDatas(h, D)
                }).then(function(i) {
                    return null !== i && i.length > 0 ? (g.debug.log("Have audio streams: " + i.length), g.manifestExt.getPrimaryAudioData(h, D).then(function(i) {
                        g.manifestExt.getDataIndex(i, h, D).then(function(a) {
                            v = a, g.debug.log("Save audio track: " + v)
                        }), g.manifestExt.getCodec(i).then(function(a) {
                            var c;
                            return g.debug.log("Audio codec: " + a), q = a, g.capabilities.supportsCodec(g.videoModel.getElement(), a) ? c = g.sourceBufferExt.createSourceBuffer(b, a) : (g.debug.log("Codec (" + a + ") is not supported."), alert("Codec (" + a + ") is not supported."), c = Q.when(null)), c
                        }).then(function(b) {
                            null === b ? g.debug.log("No buffer was created, skipping audio stream.") : (u = g.system.getObject("bufferController"), u.initialize("audio", D, i, b, a, g.videoModel), g.debug.log("Audio is ready!")), e = !0, O.call(g, d, e, f, c)
                        }, function() {
                            alert("Error creating source buffer."), e = !0, O.call(g, d, e, f, c)
                        })
                    })) : (g.debug.log("No audio streams."), e = !0, O.call(g, d, e, f, c)), g.manifestExt.getTextData(h, D)
                }).then(function(a) {
                    var i;
                    null !== a ? (g.manifestExt.getDataIndex(a, h, D).then(function(a) {
                        x = a, g.debug.log("Save text track: " + x)
                    }), g.manifestExt.getMimeType(a).then(function(a) {
                        return i = a, g.sourceBufferExt.createSourceBuffer(b, i)
                    }).then(function(b) {
                        null === b ? g.debug.log("Source buffer was not created for text track") : (w = g.system.getObject("textController"), w.initialize(D, a, b, g.videoModel), b.hasOwnProperty("initialize") && b.initialize(i, w), g.debug.log("Text is ready!"), f = !0, O.call(g, d, e, f, c))
                    }, function(a) {
                        g.debug.log("Error creating text buffer:"), g.debug.log(a), alert("Error creating source buffer."), f = !0, O.call(g, d, e, f, c)
            ...
            return a.debug.log("Getting ready for playback..."), a.manifestExt.getDurationForPeriod(D, a.manifestModel.getValue(), e).then(function(a) {
                k = a
            }), a.manifestExt.getDuration(a.manifestModel.getValue(), e).then(function(c) {
                return a.debug.log("Setting duration: " + c), a.mediaSourceExt.setDuration(b, c)
            }).then(function() {
                a.debug.log("Duration successfully set."), z = !0, c.resolve(!0)
            }), c.promise
        }, S = function() {
            this.debug.log("Got loadmetadata event."), c.resolve(null)
        }, T = function() {
            this.debug.log("Got play event."), z && (this.debug.log("Starting playback."), s && s.start(), u && u.start(), w && w.start())
        }, U = function() {
            ...
            if (-1 !== b) {
                ...
                A = !0, this.debug.log("Video Element Error: " + c), this.debug.log(this.videoModel.getElement().error), this.errHandler.mediaSourceError(c), F.call(this)
            }
        }, W = function() {
            ...
            this.debug.log("Seek complete."), this.videoModel.listen("seeking", h), this.videoModel.unlisten("seeked", i)
        }, Y = function() {}, Z = function(c) {
            var d = this;
            return d.debug.log("Stream start loading."), a = c, d.manifestModel.setValue(a), d.debug.log("Manifest has loaded."), d.debug.log(d.manifestModel.getValue()), d.manifestUpdater.init(), d.mediaSourceExt.createMediaSource().then(function(a) {
                ...
                return d.debug.log("element loaded!"), D > 0 ? (F.call(d), void 0) : ($.call(d), y && (d.debug.log("Playback initialized!"), E.call(d)), void 0)
            })
        }, $ = function() {
            var a = this,
                b = a.manifestModel.getValue(),
                c = a.manifestExt.getIsLive(b);
            c ? a.manifestExt.getLiveEdge(a.manifestModel.getValue(), D).then(function(b) {
                a.debug.log("Got live content.  Starting playback at offset: " + b), G.call(a, b + a.getTimestampOffset() + a.getLiveOffset())
            }) : a.manifestExt.getPresentationOffset(a.manifestModel.getValue(), D).then(function(b) {
                a.debug.log("Got VOD content.  Starting playback at offset: " + b), G.call(a, b + a.getTimestampOffset() + a.getLiveOffset())
            })
        }, _ = function() {
            ...
            c.debug.log("Manifest updated... set new data on buffers."), s && (a = s.getData(), a.hasOwnProperty("id") ? c.manifestExt.getDataForId(a.id, d, D).then(function(a) {
                s.setData(a)
            }) : c.manifestExt.getDataForIndex(t, d, D).then(function(a) {
                s.setData(a)
            })), u && (b = u.getData(), b.hasOwnProperty("id") ? c.manifestExt.getDataForId(b.id, d, D).then(function(a) {
                u.setData(a)
    ...
    return {
        ...
        errHandler: void 0,
        setup: function() {
            this.system.mapHandler("manifestUpdated", void 0, ab.bind(this)), this.system.mapHandler("setCurrentTime", void 0, _.bind(this)), c = Q.defer(), e = T.bind(this), f = U.bind(this), g = V.bind(this), h = W.bind(this), i = X.bind(this), j = Y.bind(this), d = S.bind(this)
        },
        load: function(a, b) {
            D = b, Z.call(this, a)
        },
        setVideoModel: function(a) {
            this.videoModel = a, this.videoModel.listen("play", e), this.videoModel.listen("pause", f), this.videoModel.listen("error", g), this.videoModel.listen("seeking", h), this.videoModel.listen("timeupdate", j), this.videoModel.listen("loadedmetadata", d)
        },
        initProtection: function() {
            l = H.bind(this), m = I.bind(this), n = J.bind(this), o = K.bind(this), this.protectionModel = this.system.getObject("protectionModel"), this.protectionModel.init(this.getVideoModel()), this.protectionController = this.system.getObject("protectionController"), this.protectionController.init(this.videoModel, this.protectionModel), this.protectionModel.listenToNeedKey(l), this.protectionModel.listenToKeyMessage(m), this.protectionModel.listenToKeyError(o), this.protectionModel.listenToKeyAdded(n)
        },
        getVideoModel: function() {
            return this.videoModel
        },
    ...
    var a, b = [],
        ...
        g = function() {
            ...
            var c = a.getElement(),
                d = b.getElement();
            return d.parentNode || c.parentNode.insertBefore(d, c), c.style.width = "0px", d.style.width = "100%", m(c, d), l(a), k(b), Q.when(!0)
        }, k = function(a) {
            a.listen("seeking", p), a.listen("progress", n), r() && a.listen("timeupdate", o)
        }, l = function(a) {
            a.unlisten("seeking", p), a.unlisten("progress", n), a.unlisten("timeupdate", o)
        }, m = function(a, b) {
            ...
            if (b.length) {
                a.getVideoModel().getCurrentTime() < b.start(0) && a.getVideoModel().setCurrentTime(b.start(0));
                var d = b.length - 1,
            ...
            b && c && b !== c && Q.when(f || !0).then(function() {
                b.pause(), a = c, f = j(b.getVideoModel(), c.getVideoModel()), d ? i(b.getVideoModel().getCurrentTime()) : a.initPlayback(), g()
            })
        };
    return {
        system: void 0,
        ...
        load: function(c) {
            ...
            f.manifestLoader.load(c).then(function(c) {
                f.manifestExt.getPeriodCount(c).then(function(g) {
                    for (var h = 0; g > h; h++) d = f.system.getObject("stream"), d.setVideoModel(0 === h ? f.videoModel : t.call(f)), d.initProtection(), d.setAutoPlay(e), d.load(c, h), b.push(d);
    ...
    var a, b = [],
        c = function() {
            ...
            null !== c && b[c] !== !0 && (b.push(c), b[c] = !0, a.playbackRate = 0)
        }, e = function(d) {
            if (null !== d) {
                b[d] = !1;
    ...
    var a, b, c = "LOADING",
        ...
        h = function(a) {
            ...
            if (e && g === d) {
                var b = this;
                h.call(b, c), b.indexHandler.getInitRequest(0, a).then(function(a) {
                    b.debug.log("Loading text track initialization: " + a.url), b.debug.log(a), b.fragmentLoader.load(a).then(k.bind(b, a), l.bind(b, a)), h.call(b, c)
                })
            }
        }, j = function() {
            i.call(this)
            ...
            var d = this;
            d.debug.log(" Text track Bytes finished loading: " + a.url), d.fragmentController.process(c.data).then(function(a) {
                null !== a && (d.debug.log("Push text track bytes: " + a.byteLength), d.sourceBufferExt.append(b, a, d.videoModel))
            })
        }, l = function(a) {
    ...
    return {
        ...
        initialize: function(a, b, c, d) {
            var f = this;
            f.setVideoModel(d), f.setPeriodIndex(a), f.setData(b), f.setBuffer(c), e = !0
        },
        getPeriodIndex: function() {
            return f
        },
    ...
    return {
        ...
        checkIndex: function(b, c, d) {
            ...
            return o.debug.log("Checking download ratio rule..."), c ? null === p || void 0 === p || 0 === p.length ? (o.debug.log("No requests made for this stream yet, bailing."), Q.when(new MediaPlayer.rules.SwitchRequest)) : (e = p[p.length - 1], g = (e.tfinish.getTime() - e.trequest.getTime()) / 1e3, f = (e.tfinish.getTime() - e.tresponse.getTime()) / 1e3, 0 >= g ? (o.debug.log("Don't know how long the download of the last fragment took, bailing."), Q.when(new MediaPlayer.rules.SwitchRequest)) : null === e.mediaduration || void 0 === e.mediaduration || e.mediaduration <= 0 ? (o.debug.log("Don't know the duration of the last media fragment, bailing."), Q.when(new MediaPlayer.rules.SwitchRequest)) : (k = Q.defer(), i = e.mediaduration / g, h = e.mediaduration / f * q, isNaN(h) || isNaN(i) ? (o.debug.log("Total time: " + g + "s"), o.debug.log("Download time: " + f + "s"), o.debug.log("The ratios are NaN, bailing."), Q.when(new MediaPlayer.rules.SwitchRequest)) : (o.debug.log("Total ratio: " + i), o.debug.log("Download ratio: " + h), o.debug.log("Download ratio: " + h), isNaN(h) ? (o.debug.log("Invalid ratio, bailing."), k.resolve(new MediaPlayer.rules.SwitchRequest)) : 1 > h ? (o.debug.log("Download ratio is poor."), b > 0 ? (o.debug.log("We are not at the lowest bitrate, so switch down."), o.manifestExt.getRepresentationFor(b - 1, d).then(function(a) {
                o.manifestExt.getBandwidth(a).then(function(a) {
                    o.manifestExt.getRepresentationFor(b, d).then(function(c) {
                        o.manifestExt.getBandwidth(c).then(function(c) {
                            j = a / c, o.debug.log("Switch ratio: " + j), j > h ? (o.debug.log("Things must be going pretty bad, switch all the way down."), k.resolve(new MediaPlayer.rules.SwitchRequest(0))) : (o.debug.log("Things could be better, so just switch down one index."), k.resolve(new MediaPlayer.rules.SwitchRequest(b - 1)))
                        })
                    })
                })
            })) : (o.debug.log("We are at the lowest bitrate and cannot switch down, use current."), k.resolve(new MediaPlayer.rules.SwitchRequest(b)))) : (o.debug.log("Download ratio is good."), o.manifestExt.getRepresentationCount(d).then(function(c) {
                c -= 1, c > b ? (o.debug.log("We are not at the highest bitrate, so switch up."), o.manifestExt.getRepresentationFor(b + 1, d).then(function(e) {
                    o.manifestExt.getBandwidth(e).then(function(e) {
                        o.manifestExt.getRepresentationFor(b, d).then(function(f) {
                            o.manifestExt.getBandwidth(f).then(function(f) {
                                if (j = e / f, o.debug.log("Switch ratio: " + j), h >= j)
                                    if (h > 1e3) o.debug.log("Tons of bandwidth available, go all the way up."), k.resolve(new MediaPlayer.rules.SwitchRequest(c - 1));
                                    else if (h > 100) o.debug.log("Just enough bandwidth available, switch up one."), k.resolve(new MediaPlayer.rules.SwitchRequest(b + 1));
                                else {
                                    for (o.debug.log("Not exactly sure where to go, so do some math."), m = -1, l = [];
                                        (m += 1) < c;) l.push(a.call(o, m, f, d));
                                    Q.all(l).then(function(a) {
                                        for (m = 0, n = a.length; n > m && !(h < a[m]); m += 1);
                                        o.debug.log("Calculated ideal new quality index is: " + m), k.resolve(new MediaPlayer.rules.SwitchRequest(m))
                                    })
                                } else o.debug.log("Not enough bandwidth to switch up."), k.resolve(new MediaPlayer.rules.SwitchRequest)
                            })
                        })
                    })
                })) : (o.debug.log("We are at the highest bitrate and cannot switch up, use current."), k.resolve(new MediaPlayer.rules.SwitchRequest(c)))
            })), k.promise))) : (o.debug.log("No metrics, bailing."), Q.when(new MediaPlayer.rules.SwitchRequest))
        }
    }
    ...
    return {
        ...
        checkIndex: function(e, f) {
            ...
            for (j.debug.log("Checking limit switches rule..."), i = m - 1; i >= 0; i -= 1) {
    ...
    "use strict";
    this.action = "download", this.startTime = 0 / 0, this.streamType = null, this.type = null, this.duration = 0 / 0, this.timescale = 0 / 0, this.range = null, this.url = null, this.requestStartDate = null, this.firstByteDate = null, this.requestEndDate = null, this.deferred = null
    ...
    "use strict";
    this.tcpid = null, this.type = null, this.url = null, this.actualurl = null, this.range = null, this.trequest = null, this.tresponse = null, this.tfinish = null, this.responsecode = null, this.interval = null, this.mediaduration = null, this.trace = []
